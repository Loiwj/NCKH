...
def build_model():
    base_model = EfficientNetB5(  # Sử dụng EfficientNetB3
        weights="imagenet",
        include_top=False,
...
checkpoint = ModelCheckpoint(
    "best_model_EfficientNetB5_v1_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_EfficientNetB5_v1_tangcuong_fold_{fold_no}.log",
        X_val,
        y_val,
        fold_no,
        f"confusion_matrix_EfficientNetB5_v1_tangcuong",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_EfficientNetB5_v1_tangcuong.txt",
    )