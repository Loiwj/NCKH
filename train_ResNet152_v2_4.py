...
# Hàm train_model
def train_model(model, criterion, optimizer, train_loader, valid_loader, test_loader, epochs=25, log_file='training_log.csv', confusion_matrix_file='confusion_matrix.csv', classification_report_file='classification_report.csv', early_stopping_patience=5):
